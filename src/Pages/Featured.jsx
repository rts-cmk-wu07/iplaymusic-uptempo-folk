          ...
          <div className="rounded-md" >
            ...
            <div className="featured-card m-auto ">
                <div className="featuredCard-top rounded-md relative">
                    <img src={item.linkImg} alt="" className=" m-auto w-[330px] h-[500px] pt-10 rounded-md shadow-black shadow-lg "/>
                    <h2 className="featuredText absolute text-3xl font-extrabold text-white top-3/4 left-1/2 -translate-x-2/3 -translate-y-1/3 ">{item.title}</h2>
