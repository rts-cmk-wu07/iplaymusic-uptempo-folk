  ...
  return (
    ...
    >
      <div className="featured-card m-auto rounded-md shadow-lg shadow-black">
        <img
          src={image}
          className="object-cover m-auto w-[310px] h-[500px] mt-10 rounded-md shadow-lg"
          alt=""
        />
        <div>
          <p className=" featuredText absolute text-2xl font-extrabold text-white top-3/4 left-1/2 -translate-x-2/3 -translate-y-1/3 ">
